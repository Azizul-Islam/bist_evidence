                ...
                <div class="row start-xs middle-xs">  
                    ...
                    <div class="row start-xs middle-xs fw-500 d-none d-md-flex d-lg-flex d-xl-flex"> 
                        <span class="d-flex center-xs middle-xs item">
                            ...
                            <span class="px-1">{{ $global->phone ?? '' }}</span>
                        </span>
                        <span class="v-divider"></span> 
                        <span class="d-flex center-xs middle-xs item">
                            <i class="material-icons mat-icon-sm">location_on</i> 
                            <span class="px-1">{{ $global->address ?? '' }}</span>
                        </span>
                        <span class="v-divider"></span>
                        <span class="d-flex center-xs middle-xs item">
                            <i class="material-icons mat-icon-sm">mail</i>  
                            <span class="px-1">{{ $global->email ?? '' }}</span>
                        </span>  
                    </div>       
                </div> 
        ...
        <div id="main-toolbar" class="mdc-elevation--z2">
            <div class="theme-container row between-xs middle-xs h-100"> 
                ...
                <div class="row middle-xs"> 
                    ...
                    @else 
                    <a href="{{ route('add-your-property') }}" class="mdc-fab mdc-fab--mini primary d-sm-none d-md-none d-lg-none d-xl-none">
                        <span class="mdc-fab__ripple"></span>
                        <span class="mdc-fab__icon material-icons">add</span>
                    </a>
                    @endif
    ...
    <div class="px-3">
        <div class="theme-container">  
            <div class="get-in-touch bg-primary"> 
                <img src="{{ asset($global->get_in_touch_photo) }}" alt="get in touch photo" class="d-none d-sm-flex d-md-flex d-lg-flex d-xl-flex">        
                <div class="row between-xs middle-xs content"> 
                    <div class="column p-3">
                        <h2>{{ $global->get_in_touch_title }}</h2>
                        <p class="mb-0">{{ $global->get_in_touch_description }}</p>
                    </div>
                    <div class="row start-xs middle-xs p-3">
                        <i class="material-icons mat-icon-xlg mx-2">call</i>
                        <div class="column">               
                            <p class="mb-0">CALL US NOW</p>
                            <h2 class="ws-nowrap">{{ $global->phone }}
                            </h2>
                        </div>
                    </div>
                    <div class="p-3">
                        <a href="{{ route('contact') }}" class="mdc-button mdc-button--raised mx-3">
                            <span class="mdc-button__ripple"></span>
