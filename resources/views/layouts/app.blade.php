            ...
            <div class="theme-container row between-xs middle-xs h-100">
                ...
                <div class="row end-xs middle-xs">
                   ...
                   <div class="mdc-menu-surface--anchor"> 
                    ...
                    <div class="mdc-menu mdc-menu-surface user-menu" id="user_menu_count">
        ...
        <div id="main-toolbar" class="mdc-elevation--z2">
            <div class="theme-container row between-xs middle-xs h-100"> 
                ...
                <div class="row middle-xs"> 
                    ...
                    @else
                    <a href="{{ route('add-your-property') }}" class="mdc-button mdc-button--raised d-none d-sm-flex d-md-flex d-lg-flex d-xl-flex">
                        <span class="mdc-button__ripple"></span>
    ...
    <div class="px-3">
        <div class="theme-container">  
            <div class="get-in-touch bg-primary"> 
                <img src="{{ asset('frontend/assets/images/others/Principal-Deluwar-Hosain.png') }}" alt="operator" class="d-none d-sm-flex d-md-flex d-lg-flex d-xl-flex">        
                <div class="row between-xs middle-xs content"> 
                    ...
                    <div class="row start-xs middle-xs p-3">
                        ...
                        <div class="column">               
                            ...
                            <h2 class="ws-nowrap">01908909090
                            </h2>
                        </div>
                    </div>
                    <div class="p-3">
