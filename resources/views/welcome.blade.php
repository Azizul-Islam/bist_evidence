...
<!-- Mirrored from www.housekey-html.themeseason.com/header-image.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 03 Oct 2021 12:05:52 GMT -->
<head>
    <meta charset="UTF-8">
    ...
    <div class="spinner-wrapper" id="preloader">
        <div class="spinner-container">
            <div class="spinner-outer">
                ...
                <p class="spinner-text">Thikana</p> 
            </div>
        </div>
    </div> 
                ...
                <div class="row start-xs middle-xs">  
                    ...
                    <div class="row start-xs middle-xs fw-500 d-none d-md-flex d-lg-flex d-xl-flex"> 
                        <span class="d-flex center-xs middle-xs item">
                            ...
                            <span class="px-1">01908909090</span>
                        </span>
                        <span class="v-divider"></span> 
                        <span class="d-flex center-xs middle-xs item">
                            <i class="material-icons mat-icon-sm">location_on</i> 
                            <span class="px-1">Wireless Gate, T&T Road, Gazipur (Abdul Hakim Super)</span>
                        </span>
                        <span class="v-divider"></span>
                        <span class="d-flex center-xs middle-xs item">
                            <i class="material-icons mat-icon-sm">mail</i>  
                            <span class="px-1">info@test.com</span>
                        </span>  
                    </div>       
                </div> 
                                    ...
                                    <div class="swiper-container">
                                        <div class="swiper-wrapper"> 
                                            <div class="swiper-slide">
                                                <img src="{{ asset('frontend/assets/images/others/transparent-bg.png') }}" alt="slide image" data-src="{{ asset('frontend/assets/images/props/flat-1/1-medium.jpg') }}" class="slide-item swiper-lazy">
                                                <div class="swiper-lazy-preloader"></div> 
                                            </div> 
                                            <div class="swiper-slide">
                                                <img src="{{ asset('frontend/assets/images/others/transparent-bg.png') }}" alt="slide image" data-src="{{ asset('frontend/assets/images/props/flat-1/2-medium.jpg') }}" class="slide-item swiper-lazy">
                                                <div class="swiper-lazy-preloader"></div> 
                                            </div> 
                                            <div class="swiper-slide">
                                                <img src="{{ asset('frontend/assets/images/others/transparent-bg.png') }}" alt="slide image" data-src="{{ asset('frontend/assets/images/props/flat-1/3-medium.jpg') }}" class="slide-item swiper-lazy">
                                                <div class="swiper-lazy-preloader"></div> 
                                            </div> 
                                            <div class="swiper-slide">
                                                <img src="{{ asset('frontend/assets/images/others/transparent-bg.png') }}" alt="slide image" data-src="{{ asset('frontend/assets/images/props/flat-1/4-medium.jpg') }}" class="slide-item swiper-lazy">
                                                <div class="swiper-lazy-preloader"></div> 
                                            </div>  
                                        </div>  
                            ...
                            <div class="thumbnail-section">
                                ...
                                <div class="property-image"> 
                                    <div class="swiper-container">
                                        <div class="swiper-wrapper"> 
                                            <div class="swiper-slide">
                                                <img src="{{ asset('frontend/assets/images/others/transparent-bg.png') }}" alt="slide image" data-src="{{ asset('frontend/assets/images/props/house-1/1-medium.jpg') }}" class="slide-item swiper-lazy">
                                                <div class="swiper-lazy-preloader"></div> 
                                            </div> 
                                            <div class="swiper-slide">
                                                <img src="{{ asset('frontend/assets/images/others/transparent-bg.png') }}" alt="slide image" data-src="{{ asset('frontend/assets/images/props/house-1/2-medium.jpg') }}" class="slide-item swiper-lazy">
                                                <div class="swiper-lazy-preloader"></div> 
                                            </div> 
                                            <div class="swiper-slide">
                                                <img src="{{ asset('frontend/assets/images/others/transparent-bg.png') }}" alt="slide image" data-src="{{ asset('frontend/assets/images/props/house-1/3-medium.jpg') }}" class="slide-item swiper-lazy">
                                                <div class="swiper-lazy-preloader"></div> 
                                            </div> 
                                            <div class="swiper-slide">
                                                <img src="{{ asset('frontend/assets/images/others/transparent-bg.png') }}" alt="slide image" data-src="{{ asset('frontend/assets/images/props/house-1/4-medium.jpg') }}" class="slide-item swiper-lazy">
                                                <div class="swiper-lazy-preloader"></div> 
                                            </div> 
                                            <div class="swiper-slide">
                                                <img src="{{ asset('frontend/assets/images/others/transparent-bg.png') }}" alt="slide image" data-src="{{ asset('frontend/assets/images/props/house-1/5-medium.jpg') }}" class="slide-item swiper-lazy">
                                                <div class="swiper-lazy-preloader"></div> 
                                            </div> 
                                            <div class="swiper-slide">
                                                <img src="{{ asset('frontend/assets/images/others/transparent-bg.png') }}" alt="slide image" data-src="{{ asset('frontend/assets/images/props/house-1/6-medium.jpg') }}" class="slide-item swiper-lazy">
                                                <div class="swiper-lazy-preloader"></div> 
                                            </div> 
                                        </div>  
                                        <div class="swiper-pagination white"></div>  
                            ...
                            <div class="thumbnail-section">
                                ...
                                <div class="property-image"> 
                                    <div class="swiper-container">
                                        <div class="swiper-wrapper"> 
                                            <div class="swiper-slide">
                                                <img src="{{ asset('frontend/assets/images/others/transparent-bg.png') }}" alt="slide image" data-src="{{ asset('frontend/assets/images/props/office-2/1-medium.jpg') }}" class="slide-item swiper-lazy">
                                                <div class="swiper-lazy-preloader"></div> 
                                            </div> 
                                            <div class="swiper-slide">
                                                <img src="{{ asset('frontend/assets/images/others/transparent-bg.png') }}" alt="slide image" data-src="{{ asset('frontend/assets/images/props/office-2/2-medium.jpg') }}" class="slide-item swiper-lazy">
                                                <div class="swiper-lazy-preloader"></div> 
                                            </div> 
                                            <div class="swiper-slide">
                                                <img src="{{ asset('frontend/assets/images/others/transparent-bg.png') }}" alt="slide image" data-src="{{ asset('frontend/assets/images/props/office-2/3-medium.jpg') }}" class="slide-item swiper-lazy">
                                                <div class="swiper-lazy-preloader"></div> 
                                            </div> 
                                            <div class="swiper-slide">
                                                <img src="{{ asset('frontend/assets/images/others/transparent-bg.png') }}" alt="slide image" data-src="{{ asset('frontend/assets/images/props/office-2/4-medium.jpg') }}" class="slide-item swiper-lazy">
                                                <div class="swiper-lazy-preloader"></div> 
                                            </div> 
                                            <div class="swiper-slide">
                                                <img src="{{ asset('frontend/assets/images/others/transparent-bg.png') }}" alt="slide image" data-src="{{ asset('frontend/assets/images/props/office-2/5-medium.jpg') }}" class="slide-item swiper-lazy">
                                                <div class="swiper-lazy-preloader"></div> 
                                            </div>
                                            <div class="swiper-slide">
                                                <img src="{{ asset('frontend/assets/images/others/transparent-bg.png') }}" alt="slide image" data-src="{{ asset('frontend/assets/images/props/office-2/6-medium.jpg') }}" class="slide-item swiper-lazy">
                                                <div class="swiper-lazy-preloader"></div> 
                                            </div>   
                                        </div>  
                                        <div class="swiper-pagination white"></div>  
                            ...
                            <div class="swiper-wrapper"> 
                                <div class="swiper-slide"> 
                                    <div class="content text-center">
                                         <img src="{{ asset('frontend/assets/images/profile/adam.jpg') }}" alt="adam">
                                ...
                                <div class="swiper-slide"> 
                                    <div class="content text-center">
                                        <img src="{{ asset('frontend/assets/images/profile/ashley.jpg') }}" alt="ashley">
                                        <div class="quote open text-left primary-color">“</div>
                                        <p class="text">Donec molestie turpis ut mollis efficitur. Nam fringilla libero vel dictum vulputate. In malesuada, ligula non ornare consequat, augue nibh luctus nisl, et lobortis justo ipsum nec velit. Praesent lacinia quam ut nulla gravida, at viverra libero euismod. Sed tincidunt tempus augue vitae malesuada. Vestibulum eu lectus nisi. Aliquam erat volutpat.</p>
                                        <div class="quote close text-right primary-color">”</div> 
                                ...
                                <div class="swiper-slide"> 
                                    <div class="content text-center">
                                        <img src="{{ asset('frontend/assets/images/profile/bruno.jpg') }}" alt="bruno">
                                        <div class="quote open text-left primary-color">“</div>
                                        <p class="text">Donec molestie turpis ut mollis efficitur. Nam fringilla libero vel dictum vulputate. In malesuada, ligula non ornare consequat, augue nibh luctus nisl, et lobortis justo ipsum nec velit. Praesent lacinia quam ut nulla gravida, at viverra libero euismod. Sed tincidunt tempus augue vitae malesuada. Vestibulum eu lectus nisi. Aliquam erat volutpat.</p>
                                        <div class="quote close text-right primary-color">”</div> 
                            ...
                            <div class="swiper-wrapper">  
                                <div class="swiper-slide"> 
                                    <div class="mdc-card o-hidden">
                                        <div>
                                            <img src="{{ asset('frontend/assets/images/others/transparent-bg.png') }}" alt="slide image" data-src="{{ asset('frontend/./assets/images/agents/a-1.jpg') }}" class="swiper-lazy d-block mw-100">
                                            <div class="swiper-lazy-preloader"></div>
                                        </div>
                                        <div class="p-3">
                                ...
                                <div class="swiper-slide"> 
                                    <div class="mdc-card o-hidden">
                                        <div>
                                            <img src="{{ asset('frontend/assets/images/others/transparent-bg.png') }}" alt="slide image" data-src="{{ asset('frontend/./assets/images/agents/a-2.jpg') }}" class="swiper-lazy d-block mw-100">
                                            <div class="swiper-lazy-preloader"></div>
                                        </div>
                                        <div class="p-3">
                                ...
                                <div class="swiper-slide"> 
                                    <div class="mdc-card o-hidden">
                                        <div>
                                            <img src="{{ asset('frontend/assets/images/others/transparent-bg.png') }}" alt="slide image" data-src="{{ asset('frontend/./assets/images/agents/a-3.jpg') }}" class="swiper-lazy d-block mw-100">
                                            <div class="swiper-lazy-preloader"></div>
                                        </div>
                                        <div class="p-3">
                                ...
                                <div class="swiper-slide"> 
                                    <div class="mdc-card o-hidden">
                                        <div>
                                            <img src="{{ asset('frontend/assets/images/others/transparent-bg.png') }}" alt="slide image" data-src="{{ asset('frontend/./assets/images/agents/a-4.jpg') }}" class="swiper-lazy d-block mw-100">
                                            <div class="swiper-lazy-preloader"></div>
                                        </div>
                                        <div class="p-3">
                                ...
                                <div class="swiper-slide"> 
                                    <div class="mdc-card o-hidden">
                                        <div>
                                            <img src="{{ asset('frontend/assets/images/others/transparent-bg.png') }}" alt="slide image" data-src="{{ asset('frontend/./assets/images/agents/a-5.jpg') }}" class="swiper-lazy d-block mw-100">
                                            <div class="swiper-lazy-preloader"></div>
                                        </div>
                                        <div class="p-3">
                            ...
                            <div class="swiper-wrapper">      
                                <div class="swiper-slide">
                                    <div class="client-item"> 
                                        <img src="{{ asset('frontend/assets/images/others/transparent-bg.png') }}" alt="slide image" data-src="{{ asset('frontend/assets/images/clients/aloha.png') }}" class="swiper-lazy"> 
                                        <div class="swiper-lazy-preloader"></div>
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="client-item"> 
                                        <img src="{{ asset('frontend/assets/images/others/transparent-bg.png') }}" alt="slide image" data-src="{{ asset('frontend/assets/images/clients/dream.png') }}" class="swiper-lazy"> 
                                        <div class="swiper-lazy-preloader"></div>
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="client-item"> 
                                        <img src="{{ asset('frontend/assets/images/others/transparent-bg.png') }}" alt="slide image" data-src="{{ asset('frontend/assets/images/clients/congrats.png') }}" class="swiper-lazy"> 
                                        <div class="swiper-lazy-preloader"></div>
                                    </div>
                                </div>
                                <div class="swiper-slide"> 
                                    <div class="client-item"> 
                                        <img src="{{ asset('frontend/assets/images/others/transparent-bg.png') }}" alt="slide image" data-src="{{ asset('frontend/assets/images/clients/best.png') }}" class="swiper-lazy"> 
                                        <div class="swiper-lazy-preloader"></div>
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="client-item"> 
                                        <img src="{{ asset('frontend/assets/images/others/transparent-bg.png') }}" alt="slide image" data-src="{{ asset('frontend/assets/images/clients/original.png') }}" class="swiper-lazy"> 
                                        <div class="swiper-lazy-preloader"></div>
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="client-item"> 
                                        <img src="{{ asset('frontend/assets/images/others/transparent-bg.png') }}" alt="slide image" data-src="{{ asset('frontend/assets/images/clients/retro.png') }}" class="swiper-lazy"> 
                                        <div class="swiper-lazy-preloader"></div>
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="client-item"> 
                                        <img src="{{ asset('frontend/assets/images/others/transparent-bg.png') }}" alt="slide image" data-src="{{ asset('frontend/assets/images/clients/king.png') }}" class="swiper-lazy"> 
                                        <div class="swiper-lazy-preloader"></div>
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="client-item"> 
                                        <img src="{{ asset('frontend/assets/images/others/transparent-bg.png') }}" alt="slide image" data-src="{{ asset('frontend/assets/images/clients/love.png') }}" class="swiper-lazy"> 
                                        <div class="swiper-lazy-preloader"></div>
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="client-item"> 
                                        <img src="{{ asset('frontend/assets/images/others/transparent-bg.png') }}" alt="slide image" data-src="{{ asset('frontend/assets/images/clients/the.png') }}" class="swiper-lazy"> 
                                        <div class="swiper-lazy-preloader"></div>
                                    </div> 
                                </div>
                                <div class="swiper-slide">
                                    <div class="client-item"> 
                                        <img src="{{ asset('frontend/assets/images/others/transparent-bg.png') }}" alt="slide image" data-src="{{ asset('frontend/assets/images/clients/easter.png') }}" class="swiper-lazy"> 
                                        <div class="swiper-lazy-preloader"></div>
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="client-item"> 
                                        <img src="{{ asset('frontend/assets/images/others/transparent-bg.png') }}" alt="slide image" data-src="{{ asset('frontend/assets/images/clients/with.png') }}" class="swiper-lazy"> 
                                        <div class="swiper-lazy-preloader"></div>
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="client-item"> 
                                        <img src="{{ asset('frontend/assets/images/others/transparent-bg.png') }}" alt="slide image" data-src="{{ asset('frontend/assets/images/clients/special.png') }}" class="swiper-lazy"> 
                                        <div class="swiper-lazy-preloader"></div>
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="client-item"> 
                                        <img src="{{ asset('frontend/assets/images/others/transparent-bg.png') }}" alt="slide image" data-src="{{ asset('frontend/assets/images/clients/bravo.png') }}" class="swiper-lazy"> 
                                        <div class="swiper-lazy-preloader"></div>
                                    </div>  
                                </div> 
                            </div> 
        ...
        <div class="px-3">
            <div class="theme-container">  
                <div class="get-in-touch bg-primary"> 
                    <img src="{{ asset('frontend/assets/images/others/operator.png') }}" alt="operator" class="d-none d-sm-flex d-md-flex d-lg-flex d-xl-flex">        
            ...
            <div class="theme-container"> 
                ...
                <div class="row between-xs middle-xs copyright">
                    ...
                    <p>Designed & Developed by 
                        <a class="mdc-button" href="http://themeseason.com/" target="_blank"> 
                            <span class="mdc-button__ripple"></span>
                            <span class="mdc-button__label">ThemeSeason</span> 
                        </a>
                    </p>
                </div> 
            </div>
