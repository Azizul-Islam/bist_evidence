@if(\App\Models\Client::where(['status'=>'active','type'=>'sister concern'])->latest()->count() > 0)
<div class="section mt-3">
    <div class="px-3">
        <div class="theme-container">
            <h1 class="section-title mb-3">Our Sister Concern</h1>
            ...
            <div class="clients-carousel"> 
                <div class="swiper-container"> 
                    <div class="swiper-wrapper"> 
                        @foreach (\App\Models\Client::where(['status'=>'active','type'=>'sister concern'])->latest()->get() as $item)
