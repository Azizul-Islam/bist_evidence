        ...
        <div class="card">
            <div class="card-body">
                <div class="d-md-flex gap-4 align-items-center">
                    <div class="d-none d-md-flex"><h4>Total Clients : {{ count($clients) }}</h4></div>
                    <div class="dropdown ms-auto">
                        <a href="{{ route('admin.clients.create') }}" class="btn btn-primary btn-icon"><i class="bi bi-plus-circle"></i> Create</a>
                    </div>
                </div>
            </div>
        </div>
