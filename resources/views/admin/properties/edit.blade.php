                        ...
                        <div class="tab-content tab-content--active">  
                                ...
                                <div class="col-xs-12 p-2">  
                                    <div class="mdc-text-field mdc-text-field--outlined mdc-text-field--textarea">
                                        <textarea class="mdc-text-field__input" rows="5" name="description" id="editor" placeholder="Enter Description" type="text">{{ old('description',$property->description) }}</textarea>
                                    </div> 
                                </div>
