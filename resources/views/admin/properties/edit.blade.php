            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-md-flex gap-4 align-items-center">
                        <div class="d-none d-md-flex"><h4>Edit Property</h4></div>
                        
                        <div class="dropdown ms-auto">
                            <a href="{{ route('admin.properties.index') }}" class="btn btn-primary btn-icon"><i class="bi bi-arrow-left-circle"></i> Back To List</a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('title') is-invalid @enderror" value="{{ old('title',$property->title) }}" name="title" id="title"
                    ...
                    <div class="mb-3">
                        ...
                        @error('photo')
                            <span class="invalid-feedback">{{ $message }}</span>
                        @enderror
                        <img src="{{ asset('backend/assets/properties/'.$property->photo) }}" width="100" class="mt-2" alt="">
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="number" min="0" class="form-control @error('price') is-invalid @enderror" value="{{ old('price',$property->price) }}" name="price" id="price"
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('address') is-invalid @enderror" value="{{ old('address',$property->address) }}" name="address" id="address"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('size') is-invalid @enderror" value="{{ old('size',$property->size) }}" name="size" id="size"
                    ...
                    <div class="mb-3">
                        ...
                        <textarea type="text" name="description" class="form-control @error('description') is-invalid @enderror" id="editor" placeholder="Enter description" cols="30" rows="5">{{ old('description',$property->description) }}</textarea>
                        @error('description')
                            <span class="invalid-feedback">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <select name="area_id" id="area_id" class="form-control @error('area_id') is-invalid @enderror">
                                    ...
                                    <option value="{{ $item->id }}" {{ $property->area_id == $item->id ? 'selected' : '' }}>{{ ucfirst($item->name) }}</option>
                                    @endforeach
                                  </select>
                                  @error('area_id')
                                        <span class="invalid-feedback">{{ $message }}</span>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3 " id="sub_area_div">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <select name="consumer" class="select2-example form-control">
                                    <option value="admin" {{ $property->consumer == 'admin' ? 'selected' : '' }}>Admin</option>
                                    <option value="owner" {{ $property->consumer == 'owner' ? 'selected' : '' }}>Owner</option>
                                    <option value="manager" {{ $property->consumer == 'manage' ? 'selected' : '' }}>Manager</option>
                                    <option value="guard" {{ $property->consumer == 'guard' ? 'selected' : '' }}>Guard</option>
                                    <option value="representative" {{ $property->consumer == 'representative' ? 'selected' : '' }}>Representative</option>
                                  </select>
                            </div>
                        </div>
                        <div class="col-md-6">
