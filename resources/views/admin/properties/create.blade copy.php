                    ...
                    <form action="{{ route('admin.properties.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('title') is-invalid @enderror"
                                value="{{ old('title') }}" name="title" id="title" placeholder="Enter Title">
                            @error('title')
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" min="0" class="form-control @error('price') is-invalid @enderror"
                                        value="{{ old('price') }}" name="price" id="price" placeholder="Enter price">
                                    @error('price')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="size" class="form-label">Size<small
                                            class="text-danger">*</small></label>
                                    <input type="text" class="form-control @error('size') is-invalid @enderror"
                                        value="{{ old('size') }}" name="size" id="size" placeholder="Enter size">
                                    @error('size')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="Status" class="form-label">Purpose <small
                                            class="text-danger">*</small></label>
                        ...
                        <div class="mb-3">
                            <label for="description" class="form-label">Descrioption <small
                        ...
                        <div class="mb-3">
                            <label for="cat_id" class="form-label">Category <small
                                    class="text-danger">*</small></label>
                            <select name="category_id" id="category_id"
                                class="select2-example form-control @error('category_id') is-invalid @enderror">
                                <option value="">Select One</option>
                                @foreach ($categories as $item)
                                    <option value="{{ $item->id }}" {{ old('category_id') ? 'selectd' : '' }}>
                                        {!! $item->name !!}</option>
                                @endforeach
                            </select>
                            @error('category_id')
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="area_id" class="form-label">Area<small
                                            class="text-danger">*</small></label>
                                    <select name="area_id" id="area_id"
                                        class="form-control @error('area_id') is-invalid @enderror">
                                        <option value="">Select One</option>
                                        @foreach ($areas as $item)
                                            <option value="{{ $item->id }}" {{ old('area_id') ? 'selectd' : '' }}>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3 d-none" id="sub_area_div">
                                    <label for="sub_area_id" class="form-label">Sub Area <small
                                            class="text-danger">(optional)</small></label>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="consumer" class="form-label">Consumer<small
                                            class="text-danger">(optional)</small></label>
                                    <select name="consumer" class="select2-example form-control">
                                        ...
                                        <option value="representative" {{ old('representative') ? 'selectd' : '' }}>
