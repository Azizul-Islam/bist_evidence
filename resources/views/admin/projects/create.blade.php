                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" min="0" class="form-control @error('price_start') is-invalid @enderror"
                                        value="{{ old('price_start') }}" name="price_start" id="price_start" placeholder="Enter price start">
                                    @error('price_start')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" min="0" class="form-control @error('price_end') is-invalid @enderror"
                                        value="{{ old('price_end') }}" name="price_end" id="price_end" placeholder="Enter price end">
                                    @error('price_end')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select name="project_status" class="@error('project_status') is-invalid @enderror form-control">
                                        ...
                                        <option value="new" {{ old('new') ? 'selectd' : '' }}>New</option>
                                        <option value="upcoming" {{ old('upcoming') ? 'selectd' : '' }}>Upcoming</option>
                                        <option value="ongoing" {{ old('ongoing') ? 'selectd' : '' }}>Ongoing</option>
                                    </select>
