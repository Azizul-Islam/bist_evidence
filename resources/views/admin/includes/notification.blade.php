            ...
            <div class="tab-pane active" id="activities">
                <div class="tab-pane-body">
                    <ul class="list-group list-group-flush">
                        @foreach(auth()->user()->unreadNotifications->where('type','App\Notifications\NewUser') as $item)
                            ...
                            <a href="#" class="d-flex">
                                ...
                                <div class="flex-grow-1">
                                    <p class="mb-0 fw-bold d-flex justify-content-between">
                                        {{ $item->data['customer_name'] }} new joined.
                                    </p>
                ...
                <div class="tab-pane-footer">
                    <a href="{{ route('mark.read') }}" class="btn btn-success">
                        <i class="bi bi-check2 me-2"></i> Make All Read
                    </a>
                    <a href="{{ route('all.notification.delete') }}" class="btn btn-danger ms-2">
