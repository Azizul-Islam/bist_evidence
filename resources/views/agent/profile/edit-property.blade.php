...
<div class="py-3">
    <div class="mdc-card p-3"> 
        <div class="mdc-tab-bar-wrapper submit-property">  
            ...
            <form action="{{ route('agent.properties.update',$property) }}" id="update_property"  method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
            <div class="tab-content tab-content--active">  
                    ...
                    <div class="col-xs-12 col-sm-6 p-2">  
                        <select name="contract" required class="mdc-select__anchor w-100 custom_select" id="">
                    ...
                    <div class="col-xs-12 col-sm-6 p-2">
                        <select name="category_id" required class="mdc-select__anchor w-100 custom_select" id="category_id">
                    ...
                    <div class="col-xs-12 col-sm-6 p-2">
                        <select name="sub_category_id" class="mdc-select__anchor w-100 custom_select" id="sub_category_id">
                    ...
                    <div class="col-xs-12 mt-2">  
                        <input  type="file" multiple name="photos[]" class="dropify"  data-allowed-file-extensions="png jpeg jpg" />
                        <div class="mt-2">
            ...
            <div class="tab-content"> 
                    ...
                    <div class="col-xs-12 col-sm-6 p-2">
                        <select name="area_id" required class="mdc-select__anchor w-100 custom_select" id="area_id">
                    ...
                    <div class="col-xs-12 col-sm-6 p-2">
                        <select name="sub_area_id" class="mdc-select__anchor w-100 custom_select" id="sub_area_id">
